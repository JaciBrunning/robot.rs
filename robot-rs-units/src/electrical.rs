...
pub type Volt         = Quantity<ISQ<N3, P2, P1, N1, Z0, Z0, Z0, Z0>>;
pub type Resistance   = Quantity<ISQ<N3, P2, P1, N2, Z0, Z0, Z0, Z0>>;
pub type Capacitance  = Quantity<ISQ<P4, N2, N1, P2, Z0, Z0, Z0, Z0>>;
pub type Inductance   = Quantity<ISQ<N2, P2, P1, N2, Z0, Z0, Z0, Z0>>;

unit!(Volt, volt, 1.0, 0.0);
unit!(Volt, millivolt, 1e-3, 0.0);
unit!(Volt, microvolt, 1e-6, 0.0);
